...
`00_世界观/小说特点.md` 是全书人物表现、叙事效果与读者预期的最高优先级来源；写任何正文、章纲或人物段落前必须阅读其最新内容。

- 每个角色必须有独立目标、信息边界、性格和说话方式。
- 角色可基于主角留下的可见证据，合理脑补其提前布局、深思熟虑或高深莫测。
- 脑补必须符合角色立场与其已知事实；不同角色应作出不同判断，不能全员同时吹捧主角。
- 脑补只能强化冲突、悬念或关系，不能取代必要的证据、行动与因果。

## 七、轻喜重构版优先规则

现有无后缀的系统规则、人物卡、总纲、卷纲、章纲与正文均保留为旧版素材，不得删除或覆盖。

后续新正文、章纲、人物设计和审稿，以以下轻喜重构资料为最高优先级：

- 00_世界观 下的三份轻喜重构规则文件
- 01_人物 下的林默轻喜重构、小旨、轻喜重构人物表
- 02_总纲 下的五卷总纲轻喜重构、爽点升级表轻喜重构
- 03_卷纲 下的卷纲第1卷轻喜重构
- 04_章纲 下的轻喜重构前10章
- 06_伏笔 下的轻喜重构伏笔表
- 07_状态 下的轻喜重构开篇状态
重构版必须保留核心循环：有效玩家提供历史共振；林默以可实现因果链改史；现实收束产生间接财富、产业机会和无形威望；收益同时带来责任、误会或审计成本。
